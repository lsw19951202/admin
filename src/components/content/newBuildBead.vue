    ...
    <div class="detail-container">
        <div class="detail-data-box">
            ...
            <div class="search-group">
                ...
                <input type="text" placeholder="请输入" v-model="sortNum">
            </div>
            <div class="search-group">
            ...
            <div style="display:flex;width:100%;">
                <div class="tofoLeft">
                    ...
                    <div class="search-group">
                        ...
                        <input type="text" placeholder="请输入" v-model="tofoNameL">
                    </div>
                    <div class="search-group">
                        <span class="totalS widthTofo">豆腐块背景色</span>
                        <input type="text" placeholder="请输入" v-model="leftBgcolor">
                    </div>
                    <div class="other">
                        <span class="widthTofo">更新描述</span>
                        <input type="text" placeholder="请简要描述该banner本次更新情况，仅作为内部说明。将不会展示到APP界面。非必填项" v-model="textValueL">
                    </div>
                    <div class="search-group">
                    ...
                    <div class="search-group">
                        ...
                        <div style="margin-left:20px;display: flex;justify-content: flex-start;align-items: center;" @change.prevent.stop="changeRadioL">
                            <label class="middlePage"><input  type="radio" name="radio1" value="1" />有中间页</label>
                            <label class="middlePage"><input  type="radio" name="radio1" value="2" />无中间页</label>
                    ...
                    <div class="configuration" v-if="isMiddlePageL==1">
                        <templete :editable='leftEdit'></templete>
                    </div>
                </div>
                <div class="tofoRight">
                    <h6>右侧豆腐块</h6>
                    <div class="search-group">
                        <span class="totalS widthTofo">豆腐块名称</span>
                        <input type="text" placeholder="请输入" v-model="tofoNameR">
                    </div>
                    <div class="search-group">
                        <span class="totalS">豆腐块背景色</span>
                        <input type="text" placeholder="请输入" v-model="rightBgcolor">
                    </div>
                    <div class="other">
                        <span class="widthTofo">更新描述</span>
                        <input type="text" placeholder="请简要描述该banner本次更新情况，仅作为内部说明。将不会展示到APP界面。非必填项" v-model="textValueR">
                    </div>
                    <div class="search-group">
                        <span class="totalS widthTofo">图片上传</span>
                        <div class="upload">
                    ...
                    <div class="search-group">
                        ...
                        <div style="margin-left:20px;display: flex;justify-content: flex-start;align-items: center;" @change.prevent.stop="changeRadioR">
                            <label class="middlePage"><input  type="radio" name="radio2" value="3" />有中间页</label>
                            <label class="middlePage"><input  type="radio" name="radio2" value="4" />无中间页</label>
                    ...
                    <div class="configuration" v-if="isMiddlePageR==3">
                        <templete :editable='rightEdit'></templete>
                    </div>
                </div>
            </div>
            <div class="search-group">
...
.widthTofo{width: 75px;display: block;text-align: right;}
</style>