...
.preview-body { flex: 1; height: 0; width: 100%; text-align: center; overflow: hidden; overflow-y: scroll; }
.phone { width: 377px; height: 669px; margin: auto; border: 1px solid #333333; color: #282828; padding: 16px 14px 14px; box-sizing: border-box; text-align: left; overflow: hidden; overflow-y: scroll; font-family: PingFang SC; }
