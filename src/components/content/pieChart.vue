<template>
    <div class="all_Box">
        ...
        <div style="width:50%;padding-left: 2rem; padding-top: 0.5rem;;box-sizing: border-box;" v-if="name=='addDate'||name=='addMonth'">
            <h1>各级拉新转化效果</h1>
            <div>
                <div class="progress">
                    <p>总监</p>
                ...
                switch (this.name) {
                    ...
                    case 'activeDate':
                        ...
                        this.rightBoby = [{
                            ...
                            name:'今日活跃用户下单率',
                            value:[val.today.member_order_user_rate,val.today.leader_order_user_rate,val.today.director_order_user_rate]
                        },{
                            name:'今日活跃用户下单数',
                            value:[val.today.member_order_user_num,val.today.leader_order_user_num,val.today.director_order_user_num]
                        },{
                            name:'环比昨日下单数',
                        ...
                        this.rightBobyNext = [{
                            name:'昨日活跃用户',
                            value:[val.yesterday.member_user_num,val.yesterday.leader_user_num,val.yesterday.director_user_num]
                        },{
                            name:'昨日活跃用户下单率',
                            value:[val.yesterday.member_order_user_rate,val.yesterday.leader_order_user_rate,val.yesterday.director_order_user_rate]
                        },{
                            name:'昨日活跃用户下单数',
                            value:[val.yesterday.member_order_user_num,val.yesterday.leader_order_user_num,val.yesterday.director_order_user_num]
                        }]
                    ...
                    case 'orderDate':
                        ...
                        this.allBody=[val.today.total_order_num,val.rate.day_order_rate,val.yesterday.total_order_num,'昨日'];
                        this.rightBobyNext = [{
                            name:'昨日下单用户',
                            value:[val.yesterday.member_user_num,val.yesterday.leader_user_num,val.yesterday.director_user_num]
                        },{
                            ...
                            name:'昨日下单数',
                            value:[val.yesterday.member_order_num,val.yesterday.leader_order_num,val.yesterday.director_order_num]
                        }]
                    ...
                    case 'orderMonth':
                        ...
                        this.rightBoby = [{
                            name:'本月下单用户',
                            value:[val.thisMonth.member_user_num,val.thisMonth.leader_user_num,val.thisMonth.director_user_num]
                        },{
                            name:'本月下单率',
                            value:[val.thisMonth.member_user_num,val.thisMonth.leader_user_num,val.thisMonth.director_user_num]
                        },{
                            name:'本月下单数',
                            value:[val.thisMonth.member_order_num,val.thisMonth.leader_order_num,val.thisMonth.director_order_num]
                        },{
                            name:'环比上月下单数',
                            value:[val.rate.day_member_order_rate,val.rate.day_leader_order_rate,val.rate.day_director_order_rate]
                        }]
                        this.allBody=[val.thisMonth.total_order_num,val.rate.month_order_rate,val.lastMonth.total_order_num,'上月'];
                        this.rightBobyNext = [{
                            name:'上月下单用户',
                            value:[val.yesterday.member_user_num,val.lastMonth.leader_user_num,val.lastMonth.director_user_num]
                        },{
                            name:'上月下单率',
                            value:[val.lastMonth.member_user_num,val.lastMonth.leader_user_num,val.lastMonth.director_user_num]
                        },{
                            name:'上月下单数',
                            value:[val.lastMonth.member_order_num,val.lastMonth.leader_order_num,val.lastMonth.director_order_num]
                        }]
                    ...
                    case 'shareDate':
                        ...
                        this.rightBoby = [{
                            ...
                            name:'环比昨日转化率',
                            value:[val.rate.day_tb_valid_change_rate,val.rate.day_jd_valid_change_rate	,val.rate.day_pdd_valid_change_rate	]
                        }]
                        ...
                        this.rightBobyNext = [{
                            ...
                            name:'昨日分享转化率',
                            value:[val.yesterday.tb_valid_change_rate,val.yesterday.jd_valid_change_rate,val.yesterday.pdd_valid_change_rate]
                        }]
                    ...
                    case 'shareMonth':
                        ...
                        this.rightBoby = [{
                            ...
                            name:'本月分享转化率',
                            value:[val.thisMonth.tb_valid_change_rate,val.thisMonth.jd_valid_change_rate,val.thisMonth.pdd_valid_change_rate]
                        },{
                            name:'环比上月转化率',
                            value:[val.rate.month_tb_valid_change_rate,val.rate.month_jd_valid_change_rate	,val.rate.month_pdd_valid_change_rate	]
                        }]
                        ...
                        this.rightBobyNext = [{
                            ...
                            name:'上月分享转化率',
                            value:[val.lastMonth.tb_valid_change_rate,val.lastMonth.jd_valid_change_rate,val.lastMonth.pdd_valid_change_rate]
                        }]
                    ...
                    if(res.status == 200){
                        ...
                        if(res.data.code == 200){
                            const rest = res.data.data;
                                this.rightBoby = [{
                                    name:'本月活跃用户',
                                    value:[rest.thisMonth.member_user_num,rest.thisMonth.leader_user_num,rest.thisMonth.director_user_num]
                                },{
                                    name:'本月活跃用户下单率',
                                    value:[rest.thisMonth.member_order_user_rate,rest.thisMonth.leader_order_user_rate,rest.thisMonth.director_order_user_rate]
                                },{
                                    name:'本月活跃用户下单数',
                                    value:[rest.thisMonth.member_order_user_num,rest.thisMonth.leader_order_user_num,rest.thisMonth.director_order_user_num]
                                },{
                                    name:'环比上月下单数',
                                    value:[rest.rate.month_member_order_rate,rest.rate.month_leader_order_rate,rest.rate.month_director_order_rate]
                                }]
                                this.allBody=[rest.thisMonth.total_user_num,rest.rate.month_rate,rest.lastMonth.total_user_num,'上月'];
                                this.rightBobyNext = [{
                                    name:'本月活跃用户',
                                    value:[rest.lastMonth.member_user_num,rest.lastMonth.leader_user_num,rest.lastMonth.director_user_num]
                                },{
                                    name:'本月活跃用户下单率',
                                    value:[rest.lastMonth.member_order_user_rate,rest.lastMonth.leader_order_user_rate,rest.lastMonth.director_order_user_rate]
                                },{
                                    name:'本月活跃用户下单数',
                                    value:[rest.lastMonth.member_order_user_num,rest.lastMonth.leader_order_user_num,rest.lastMonth.director_order_user_num]
                                }]
...
<style scoped>
    ...
    .choose{color: #000!important;border: 1px solid gainsboro;}
    .tabChecked{color: #fff!important;border: 1px solid gainsboro;background-color: #ff6600;padding: 0.15rem 0.4rem;}
    .tabCheck{color: #000!important;border: 1px solid gainsboro;background-color: #fff;padding: 0.15rem 0.4rem;}
    .quantum_rate{display: flex;justify-content: space-between;padding: 0 1rem;box-sizing: border-box;align-items: center;}
</style>
