...
export default {
    ...
    computed: {
        ...
        downloadUrl: function(){
            return setting.baseUrl + setting.urls.cpsperYear + '?company_id=' + this.company_id + '&statistics_year=' + (this.company_id == 1 ? this.start_time_sc : (this.company_id == 2 ? this.start_time_cd : this.start_time_all)) + '&page=' + 1 + '&is_excel=1&skey=' + this.$cookies.get('skey')
        },
        getTimeIn: function(){
    ...
    created: function(){
        ...
        return Promise.all([
            ...
            this.loadTBData(setting.urls.cpsperYear, {'company_id': 1, page: 1, 'statistics_year': this.start_time_sc}, 'get'),
            this.loadTBData(setting.urls.cpsperYear, {'company_id': 2, page: 1, 'statistics_year': this.start_time_cd}, 'get'),
            this.loadTBData(setting.urls.cpsperYear, {'company_id': 0, page: 1, 'statistics_year': this.start_time_all}, 'get')
        ]).then(rst => {
    ...
    methods: {
        ...
        loadData: function(){
            ...
            this.showLoading()
            this.loadTBData(setting.urls.cpsperYear, queryParams, 'get')
                .then((rst) => {
