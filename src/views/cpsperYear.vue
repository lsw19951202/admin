...
export default {
    ...
    computed: {
        ...
        downloadUrl: function(){
            return setting.baseUrl + setting.urls.cpsperYear + '?company_id=' + this.company_id + '&statistics_year=' + this.start_time + '&page=' + 1 + '&is_excel=1&skey=' + this.$cookies.get('skey')
        }
    },
    created: function(){
        this.showLoading()
