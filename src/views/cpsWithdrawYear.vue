    ...
    <div class="detail-container hideScrollBar">
        <div class="detail-data-box nopadding">
            <div class="detail-main">
                ...
                <div class="table_title">云瞻信息{{start_time}}年CPS业务提现统计表</div>
...
export default {
    ...
    data: () => {
        ...
        return {
            ...
            tbData: {
                tableHeader: setting.tableHeader.cpswithdrawYear,
                tbData: [],
                lockedRow: 3,
                lockedCol: 2
            },
    ...
    methods: {
        ...
        loadData: function(pageNum){
            this.showLoading()
            this.loadTBData(setting.urls.cpswithdrawYear, {'statistics_year': this.start_time, page: pageNum || 1}, 'get')
                .then(rst => {
                    console.log(rst)
