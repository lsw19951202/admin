    ...
    <div class="detail-container">
        ...
        <div class="detail-data-box">
            <header class="search-header">
                ...
                <div class="search-group">
                    <label>联盟账号名称:</label>
                    <input type="text" placeholder="请输入" v-model="accounts_name">
                </div>
...
export default {
    ...
    methods: {
        ...
        createConfigData: function(dt){
            ...
            this.$data['accounts_name'] = dt.condition_config.robot_name
        },
            ...
            request({
                ...
                if(resp.status == 200){
                    ...
                    if(rst.code == 200){
                        ...
                        this.alert(rst.message || '加载联盟订单数据失败')
                    }
                }else{
                    this.alert('加载联盟订单数据失败')
                }
            }).catch((error) => {
                this.alert('加载联盟订单数据失败')
            }).then(() => {
