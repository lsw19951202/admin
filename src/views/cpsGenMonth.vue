        ...
        <div class="detail-data-box nopadding">
            <div class="detail-main">
                <header class="search-header">
                    ...
                    <a class="action-btn" style="display: inline-block;" :href="downloadUrl" download="月度推广费用.xlsx">导出</a>
                </header>
                <div class="table_title">四川云瞻CPS业务推广费汇统计表</div>
...
export default {
    ...
    data: () =>{
        ...
        return {
            ...
            tbData: {
                tableHeader: setting.tableHeader.cpsgenMonth,
                tbData: [],
                lockedRow: 1,
                lockedCol: 2
            },
    ...
    computed: {
        downloadUrl: function(){
            return setting.baseUrl + setting.urls.cpsgenMonth + '?statistics_month=' + this.start_time + '&is_excel=1&skey=' + this.$cookies.get('skey')
        }
    },
    created: function(){
        this.showLoading()
        return Promise.all([
            this.loadFields(setting.urls.cpsFields, {'order_type': 'generalizemonth'}),
            this.loadTBData(setting.urls.cpsgenMonth, {'statistics_month': this.start_time}, 'get')
        ]).then(rst => {
